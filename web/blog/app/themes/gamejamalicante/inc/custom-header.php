<?php
/**
 * Implement an optional custom header for gamejamua
 *
 ...
 * @uses gamejamua_header_style() to style front-end.
 * @uses gamejamua_admin_header_style() to style wp-admin form.
 * @uses gamejamua_admin_header_image() to add custom markup to wp-admin form.
 *
 * @since gamejamua 1.0
 */
