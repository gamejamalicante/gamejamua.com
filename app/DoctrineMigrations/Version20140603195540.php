 ...
 */
class Version20140603195540 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE gamejam_compos_teams (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, name VARCHAR(255) NOT NULL, nameSlug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE gamejam_compos (id INT AUTO_INCREMENT NOT NULL, theme_id INT DEFAULT NULL, memberFee NUMERIC(2, 0) NOT NULL, normalFee NUMERIC(2, 0) NOT NULL, name VARCHAR(255) NOT NULL, nameSlug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, open TINYINT(1) NOT NULL, startAt DATETIME NOT NULL, period VARCHAR(255) NOT NULL, applicationStartAt DATETIME NOT NULL, applicationPeriod VARCHAR(255) NOT NULL, maxPeople SMALLINT NOT NULL, UNIQUE INDEX UNIQ_4CC8A80B59027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE gamejam_compos_contributors (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, nameSlug VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, featured TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE gamejam_compos_activity (id INT AUTO_INCREMENT NOT NULL, compo_id INT DEFAULT NULL, user_id INT DEFAULT NULL, game_id INT DEFAULT NULL, achievement_id INT DEFAULT NULL, media_id INT DEFAULT NULL, download_id INT DEFAULT NULL, date DATETIME NOT NULL, type SMALLINT NOT NULL, content LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json_array)', INDEX IDX_FE213525F1454301 (compo_id), INDEX IDX_FE213525A76ED395 (user_id), INDEX IDX_FE213525E48FD905 (game_id), INDEX IDX_FE213525B3EC99FE (achievement_id), INDEX IDX_FE213525EA9FDD75 (media_id), INDEX IDX_FE213525C667AEAB (download_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE gamejam_compos_achievements (id INT AUTO_INCREMENT NOT NULL, type SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, nameSlug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, granter VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE gamejam_compos_notifications (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, announce TINYINT(1) NOT NULL, date DATETIME NOT NULL, type SMALLINT NOT NULL, content LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE gamejam_compos_applications (id INT AUTO_INCREMENT NOT NULL, compo_id INT DEFAULT NULL, user_id INT DEFAULT NULL, team_id INT DEFAULT NULL, order_id INT DEFAULT NULL, date DATETIME NOT NULL, modality SMALLINT NOT NULL, nightStay TINYINT(1) NOT NULL, completed TINYINT(1) NOT NULL, INDEX IDX_AB4D5307F1454301 (compo_id), INDEX IDX_AB4D5307A76ED395 (user_id), INDEX IDX_AB4D5307296CD8AE (team_id), UNIQUE INDEX UNIQ_AB4D53078D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE gamejam_games (id INT AUTO_INCREMENT NOT NULL, compo_id INT DEFAULT NULL, team_id INT DEFAULT NULL, user_id INT DEFAULT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, name VARCHAR(255) NOT NULL, nameSlug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, likes INT NOT NULL, coins INT NOT NULL, INDEX IDX_98394EDCF1454301 (compo_id), INDEX IDX_98394EDC296CD8AE (team_id), INDEX IDX_98394EDCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE gamejam_games_downloads (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, gamejam TINYINT(1) NOT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, version VARCHAR(255) NOT NULL, fileUrl LONGTEXT NOT NULL, platforms LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', comment LONGTEXT NOT NULL, size VARCHAR(255) NOT NULL, INDEX IDX_1337C2F7E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE gamejam_games_media (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, filePath VARCHAR(255) DEFAULT NULL, data LONGTEXT DEFAULT NULL COMMENT '(DC2Type:array)', comment VARCHAR(255) NOT NULL, type SMALLINT NOT NULL, INDEX IDX_1C08298FE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE gamejam_users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, username_canonical VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, email_canonical VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, locked TINYINT(1) NOT NULL, expired TINYINT(1) NOT NULL, expires_at DATETIME DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT '(DC2Type:array)', credentials_expired TINYINT(1) NOT NULL, credentials_expire_at DATETIME DEFAULT NULL, registeredAt DATETIME NOT NULL, coins INT NOT NULL, nickname VARCHAR(255) DEFAULT NULL, avatarUrl LONGTEXT DEFAULT NULL, birthDate DATE DEFAULT NULL, sex TINYINT(1) DEFAULT NULL, siteUrl VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, presentation LONGTEXT DEFAULT NULL, publicProfile TINYINT(1) NOT NULL, publicEmail TINYINT(1) NOT NULL, readNotifications LONGTEXT NOT NULL COMMENT '(DC2Type:array)', allowCommunications TINYINT(1) NOT NULL, oauthTokens LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', twitter VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_7399C00492FC23A8 (username_canonical), UNIQUE INDEX UNIQ_7399C004A0D96FBF (email_canonical), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("ALTER TABLE gamejam_compos_applications ADD CONSTRAINT FK_AB4D5307296CD8AE FOREIGN KEY (team_id) REFERENCES gamejam_compos_teams (id)");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE gamejam_compos_applications DROP FOREIGN KEY FK_AB4D5307296CD8AE");
